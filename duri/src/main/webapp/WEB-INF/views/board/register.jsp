...
<form role="form" action="/duri/board/register" method="post" id="regForm" enctype="multipart/form-data">
...
<div id="butt">
<a href="/duri/board/list"><input type="button" id="cbtn" value="취소"></a>
